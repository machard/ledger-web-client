...
var LedgerWebCLient = /** @class */ (function () {
    function LedgerWebCLient(stream) {
        var _this = this;
        this.requests = {};
        this.stream = stream;
    ...
    LedgerWebCLient.prototype.request = function (type, method, args) {
...
exports.default = LedgerWebCLient;
